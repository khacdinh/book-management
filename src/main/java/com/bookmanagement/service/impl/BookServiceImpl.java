...
import com.bookmanagement.entity.UserForm;
...
public class BookServiceImpl implements BookService {
	...
	public BookDetail viewBookDetail(Long id) {
		...
		bookDetail.setDateCreate(book.getDateCreate() != null
				? DateFormatUtils.format(book.getDateCreate(), "yyyy-MM-dd HH:mm:ss") : "");
		bookDetail.setDateUpdate(book.getDateUpdate() != null
				? DateFormatUtils.format(book.getDateUpdate(), "yyyy-MM-dd HH:mm:ss") : "");
		return bookDetail;
	}
